"""Row/column diacritics for kitty's Unicode image placeholders.

Generated from kitty's gen/rowcolumn-diacritics.txt, which derives it from
UnicodeData.txt 6.0.0. The index of a codepoint in this list is the row or
column number it encodes, so the order matters and must not be sorted.
"""
